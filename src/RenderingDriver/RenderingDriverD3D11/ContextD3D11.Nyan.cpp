...
namespace Xe {
	namespace Graphics {
		...
		bool CContextD3D11::CreateDevice(const ContextInitDesc& properties) {
			...
			{
				// Accertarsi che DXGI non metta in coda pi� di un frame alla volta. Ci� consente sia di ridurre la latenza sia
		...
		bool CContextD3D11::IsSdkLayersAvailable() {
			HRESULT hr = D3D11CreateDevice(
				nullptr,
				D3D_DRIVER_TYPE_NULL,       // Non � necessario creare un dispositivo hardware reale.
				0,
				D3D11_CREATE_DEVICE_DEBUG,  // Verificare i livelli SDK.
				nullptr,                    // Qualsiasi livello di funzionalit� � valido.
				0,
				D3D11_SDK_VERSION,          // Impostare sempre questo su D3D11_SDK_VERSION per le applicazioni Windows Store.
				nullptr,                    // Non � necessario mantenere il riferimento dispositivo D3D.
				nullptr,                    // Non � necessario conoscere il livello di funzionalit�.
